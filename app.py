...
def receive_application():
    ...
    <body>
        <div class="container">
            ...
            <p class="content">We are pleased to inform you that the application submitted by the student <b>{studentName}</b> with register number <b>{registerNo}</b> has been <b>approved</b>.</p>
